 ...
 * time-intervals.
 */
abstract public class SeaShell {
  ...
  protected abstract String getStdInput();
   ...
   */
  public static class ShellCommandExecutor extends SeaShell {
    ...
    public ShellCommandExecutor(List<String> execString, String stdinput) {
        this(execString.toArray(new String[execString.size()]), null);
  ...
  private static class ShellTimeoutTimerTask extends TimerTask {
    ...
    private SeaShell shell;

    public ShellTimeoutTimerTask(SeaShell shell) {
      this.shell = shell;
    }
